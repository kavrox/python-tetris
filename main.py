...
high_score_rect = pygame.Rect(320, 480 , 170, 60)
...
while True:
	...
	high_score_value_surface = title_font.render(str(hs.highscore), True, Colors.white)

	screen.fill(Colors.dark_blue)
	screen.blit(score_surface, (365, 20, 50, 50))
	screen.blit(next_surface, (375, 180, 50, 50))
	screen.blit(high_score_surface, (320, 430, 50, 50))

	if game.game_over == True:
		hs.update_highscore(game.score)
		screen.blit(game_over_surface, (320, 570, 50, 50))
	...
	screen.blit(high_score_value_surface, high_score_value_surface.get_rect(centerx = high_score_rect.centerx, 
